    ...
    <div>
      ...
      <nav
        className={`fixed top-0 left-0 w-full z-50 flex items-center justify-between px-4 sm:px-8 py-4 border-b-2 ${
          isMenuOpen ? "bg-transparent  text-customRed" : "bg-transparent text-white"
        }`}
        style={{
  ...
  >
    <div className="h-[calc(100vh-80px)] mt-20 overflow-y-auto md:overflow-hidden relative">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-0 w-full h-full border-t-4 border-white md:h-[calc(100vh-80px)]">
        <div
          className="border border-white flex justify-start md:justify-center items-center text-5xl sm:text-7xl md:text-8xl lg:text-[11vw] font-black leading-none text-white font-[Poor Story] p-8 md:p-4 md:pl-4 cursor-pointer"
        ...
        <div
          className="border border-white flex justify-start md:justify-center items-center text-5xl sm:text-7xl md:text-8xl lg:text-8xl font-black leading-none text-white font-[Poor Story] p-8 md:p-4 md:pl-4 cursor-pointer"
        ...
        <div
          className="border border-white flex justify-start md:justify-center items-center text-5xl sm:text-7xl md:text-8xl lg:text-[11vw] font-black leading-none text-white font-[Poor Story] p-8 md:p-4 cursor-pointer"
        ...
        <div className="border border-white flex flex-col sm:flex-row justify-start md:justify-center items-center text-lg sm:text-xl font-extrabold p-6 md:p-4 pl-12 md:pl-4 space-y-4 sm:space-y-0 cursor-pointer">
          <a href="#" className="hover:underline mx-4 text-center text-white font-black">
